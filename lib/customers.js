...
function update (id, data, userToken, txId) {
  ...
  console.log("In customer.js - update");
  ...
  console.log("In customer.js - sql");
  console.log(sql);
...
function addComplianceOverrides (id, customer, userToken) {
  console.log("In addComplianceOverrides - id");
  console.log(id);

  console.log("In addComplianceOverrides - customer");
  console.log(customer);

  console.log("In addComplianceOverrides - userToken");
  console.log(userToken);

  console.log(getComplianceTypes());
  ...
  console.log("In addComplianceOverrides");
...
function getCustomersList () {
  ...
  limit $3`
  return db.any(sql, [ passableErrorCodes, anonymous.uuid, NUM_RESULTS ])
    .then(customers => Promise.all(_.map(customer => {
      return populateOverrideUsernames(customer)
        .then(camelize)
    }, customers)))
...
function updatePhotoCard (id, patch) {
  return Promise.resolve(patch)
    .then(patch => {
      ...
      //Override should be removed -- right?? //Added by shiv
      newPatch.idCardPhotoOverride = 'automatic';
